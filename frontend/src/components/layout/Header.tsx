...
export default function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 h-16 bg-surface border-b border-border px-4 lg:px-6">
      <div className="flex items-center justify-between h-full">
        {/* Left */}
        <div className="flex items-center gap-4">
          <button
            onClick={onMenuClick}
            className="lg:hidden p-2 rounded-lg text-gray-400 hover:bg-surface-raised transition-colors"
          >
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={notificationRef}>
            <button
              ...
              className="relative p-2 rounded-lg text-gray-400 hover:bg-surface-raised transition-colors"
            >
            ...
            {showNotifications && (
              <div className="absolute right-0 mt-2 w-80 bg-surface rounded-xl border border-border shadow-lg overflow-hidden">
          ...
          <div className="relative" ref={dropdownRef}>
            <button
              ...
              className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-surface-raised transition-colors"
            >
            ...
            {/* Dropdown */}
            {showDropdown && (
              <div className="absolute right-0 mt-2 w-56 bg-surface rounded-xl border border-border shadow-lg py-1">
