  ...
  return (
    ...
    >
      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-1">캠페인 번호</label>
          <input
            type="text"
            value={campaignCode}
            onChange={(e) => setCampaignCode(e.target.value)}
            className="w-full border border-border-strong rounded-lg px-3 py-2 text-sm bg-surface text-gray-200 font-mono focus:outline-none focus:ring-2 focus:ring-primary-400/40"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-1">상호명</label>
            <input
              type="text"
              value={placeName}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-1">대행사</label>
            <input
              type="text"
              value={agencyName}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-1">일일한도 (타수)</label>
            <input
              type="number"
              value={dailyLimit}
          ...
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-1">전체한도</label>
            <input
              type="number"
              value={totalLimit}
        ...
        <div>
          <div className="flex items-center justify-between mb-1">
            <label className="block text-sm font-medium text-gray-300">키워드</label>
            {!keywordsLoaded && (
              <button
          ...
          {keywordsLoaded ? (
            ...
            <div className="text-xs text-gray-400 border border-border rounded-lg px-3 py-2">
        ...
        {campaign.extension_history && campaign.extension_history.length > 0 && (
          <div className="p-3 bg-surface-raised rounded-lg">
            <div className="text-sm font-medium text-gray-300 mb-2">연장 이력</div>
