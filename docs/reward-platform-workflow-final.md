...
flowchart TD
    ...
    subgraph PHASE4["⚙️ PHASE 4: 자동 세팅 + 담당자 확인"]
        ...
        D_AUTO["자동 세팅 로직 실행<br/>(Quantum 연동)<br/>━━━━━━━━━━━━━<br/>• 키워드 자동 추출 & 세팅<br/>• 네트워크 자동 배정<br/>• 10,000 전환수 초과 시<br/>  네트워크 자동 변경"]
    end
...
flowchart TD
    ...
    subgraph EXT_FLOW["🔄 연장 세팅 플로우"]
        ...
        EF2{"누적 전환수 체크<br/>기존 타수 + 신규 타수<br/>> 10,000?"}
...
8. **네트워크 변경 트리거.** 연장 시 누적 전환수 > 10,000이면 동일 구좌 내 다음 네트워크로 이동.
